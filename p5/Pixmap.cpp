...
/* static */ std::shared_ptr<Pixmap::Pixmap_data> Pixmap::default_pixmap_data = 0;
/* static */ map<string, std::shared_ptr<Pixmap::Pixmap_data>> Pixmap::m_pixmap_cache;

//Pixmap
/*static*/ std::map<const std::string, Gpl_type> Pixmap::var_types
{
  {"filename",        STRING},
};

/*static*/ Gpl_type Pixmap::get_member_variable_type(const std::string& name)
{
  try {
...
Pixmap::Pixmap(bool draw_me)
  : Game_object(draw_me, 0.5, 0.5, 0.5)
{
