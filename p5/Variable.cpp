...
void Variable::assign(Constant* cptr){
  switch (symbol->get_type){
    case INT:
    ...
    case ANIMATION_BLOCK:
      ...
      break;
    default:
      std::cerr << "operator called on invalid Variable type\n";
      break;
  }
}
void Variable::plus_equals(Constant* cptr){
  switch (symbol->get_type){
    case INT:
      symbol->as_int() = cptr->as_int();
      break;
...
void Variable::minus_equals(Constant* cptr){
  switch (symbol->get_type){
    case INT:
      symbol->as_int() = cptr->as_int();
      break;
