...
Member variables
 [Todd says: Some of below is outdated. I converted the member function that interrogates type to be static]
 Motivation:
 ...
 Solution:
  ...
  Access:
      ...
      The gpl code can set/get member variables by using the member functions.
      For the get_* functions, the desired value is assigned to the variable
      passed in by reference.

        void set_member_variable(string name, int value);
        void set_member_variable(string name, double value);
        void set_member_variable(string name, string *value);
        ...

        void get_member_variable(string name, int &value);
        void get_member_variable(string name, double &value);
        void get_member_variable(string name, string &value);
        ...

    The get/set functions may throw the following exceptions:
        ...
        This enum is defined in gpl_types.h
...
class Game_object
{
  public:
    ...
    Game_object(bool draw_me, double red, double green, double blue);
    virtual ~Game_object();
    ...
    void set_member_variable(std::string name, int value);
    void set_member_variable(std::string name, double value);
    void set_member_variable(std::string name, std::string value);
    void set_member_variable(std::string name, Animation_block *block);

      

    void get_member_variable(std::string name, int &value);
    void get_member_variable(std::string name, double &value);
    void get_member_variable(std::string name, std::string &value);
    void get_member_variable(std::string name, Animation_block *&value);
  ...
  protected:
    static Gpl_type get_member_variable_type(const std::string& name); //tagger
  ...
  public:
    const bool draw_me;
  private:
    struct Typed_void_ptr
    {
      public:
        Typed_void_ptr(Gpl_type type, void *value, const std::string& name) 
          : m_type(type), m_value(value), m_derived(false), m_name(name)
         {}
        ~Typed_void_ptr();
        Gpl_type m_type;
        void *m_value;
    ...
    std::map<std::string, std::shared_ptr<Typed_void_ptr> > m_variable_registry;
    std::shared_ptr<Game_object::Typed_void_ptr> lookup_registered_member_variable(std::string name);
